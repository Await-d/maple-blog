...
public class UpdatePostDto
{
    ...
    /// <summary>
    /// Whether to update the modification date
    /// </summary>
    public bool UpdateModificationDate { get; set; } = true;

    /// <summary>
    /// Version comment for this update
    /// </summary>
    [StringLength(500, ErrorMessage = "Version comment must not exceed 500 characters")]
